...
class BoneAnimNode extends Node {
    ...
    sortAndAddBones(bones) {
        ...
        bones.forEach(bone => {
            console.log(bone.name, bone.zIndex)
    ...
    update(dt) {
        ...
        //  console.log(anchorBone)
        //  throw new Error()
         if (anchorBone) {
            this.syncroNode.pos.x = -(anchorBone.pos.x + anchorBone.anchor.x + anchorBone.length * Math.cos(anchorBone.angle))
            this.syncroNode.pos.y = -(anchorBone.pos.y + anchorBone.anchor.y + anchorBone.length * Math.sin(anchorBone.angle))
         }
    }
}
